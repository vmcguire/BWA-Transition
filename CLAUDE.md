...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Transition/`**
...
```bash
git subtree push --prefix=BWA-Transition git@github.com:vmcguire/BWA-Transition.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Transition.vst3`.
